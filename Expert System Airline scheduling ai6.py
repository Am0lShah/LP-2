...
class CargoSchedule:
    ...
    def search_cargos(self, origin, destination):
        return [
            ...
            if cargo['origin'] == origin and cargo['destination'] == destination
        ]
...
def main():
    ...
    airline_schedule.add_flight({
        'flight_number': "F001", 'departure': "New York", 'destination': "London",
        'departure_time': "08:00", 'arrival_time': "14:00"
    })
    airline_schedule.add_flight({
        'flight_number': "F002", 'departure': "London", 'destination': "Paris",
        'departure_time': "15:30", 'arrival_time': "17:00"
    })
    airline_schedule.add_flight({
        'flight_number': "F003", 'departure': "Paris", 'destination': "Rome",
        'departure_time': "18:30", 'arrival_time': "20:00"
    })

    # Adding example cargos
    cargo_schedule.add_cargo({
        'cargo_id': "C001", 'flight_number': "F001", 'weight': 500,
        'origin': "New York", 'destination': "London"
    })
    cargo_schedule.add_cargo({
        'cargo_id': "C002", 'flight_number': "F002", 'weight': 300,
        'origin': "London", 'destination': "Paris"
    })
    cargo_schedule.add_cargo({
        'cargo_id': "C003", 'flight_number': "F003", 'weight': 700,
